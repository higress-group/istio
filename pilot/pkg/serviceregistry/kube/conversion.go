...
func IsAutoPassthrough(gwLabels map[string]string, l gatewayv1.Listener) bool {
	if l.TLS == nil {
		return false
	}
...
func hasListenerMode(l gatewayv1.Listener, mode string) bool {
...
func GatewaySA(gw *gatewayv1.Gateway) string {
